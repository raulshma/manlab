...
[JsonSerializable(typeof(ProcessTelemetry))]
[JsonSerializable(typeof(List<ProcessTelemetry>))]
[JsonSerializable(typeof(GpuTelemetry))]
[JsonSerializable(typeof(List<GpuTelemetry>))]
[JsonSerializable(typeof(UpsTelemetry))]
[JsonSerializable(typeof(TelemetryHistoryResponse))]
[JsonSerializable(typeof(TelemetryHistoryPoint))]
[JsonSerializable(typeof(List<TelemetryHistoryPoint>))]
...
[JsonSerializable(typeof(StreamDownloadPayload))]
[JsonSerializable(typeof(FileStreamMetadata))]
[JsonSerializable(typeof(StreamChunkHeader))]
[JsonSerializable(typeof(ZipCreationSummary))]
