...
namespace ManLab.Server.Data.Migrations
{
    ...
    [Migration("20260209143540_AddWidgetPercentDimensions")]
    partial class AddWidgetPercentDimensions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.SystemUpdateHistory", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<string>("PostUpdateStateJson")
                        .HasColumnType("jsonb");

                    b.Property<string>("PreUpdateStateJson")
                        .HasColumnType("jsonb");

                    b.Property<bool>("RebootApproved")
                        .HasColumnType("boolean");

                    b.Property<bool>("RebootRequired")
                        .HasColumnType("boolean");

                    b.Property<DateTime?>("RebootedAt")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.SystemUpdateLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid>("UpdateHistoryId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("UpdateHistoryId");

                    b.HasIndex("UpdateHistoryId", "TimestampUtc");

                    b.ToTable("SystemUpdateLogs");
                });

            modelBuilder.Entity("ManLab.Server.Data.Entities.TelemetryRollup", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint");
                    ...
                    b.Property<float?>("CpuAvg")
                        .HasColumnType("real");

                    b.Property<float?>("CpuMax")
                        .HasColumnType("real");

                    b.Property<float?>("CpuMin")
                        .HasColumnType("real");

                    b.Property<float?>("CpuP95")
                        .HasColumnType("real");

                    b.Property<float?>("DiskAvg")
                        .HasColumnType("real");

                    b.Property<float?>("DiskMax")
                        .HasColumnType("real");

                    b.Property<float?>("DiskMin")
                        .HasColumnType("real");

                    b.Property<float?>("DiskP95")
                        .HasColumnType("real");

                    b.Property<int>("Granularity")
                        .HasColumnType("integer");

                    b.Property<double?>("NetRxAvg")
                        .HasColumnType("double precision");

                    b.Property<double?>("NetRxMax")
                        .HasColumnType("double precision");

                    b.Property<double?>("NetRxP95")
                        .HasColumnType("double precision");

                    b.Property<double?>("NetTxAvg")
                        .HasColumnType("double precision");

                    b.Property<double?>("NetTxMax")
                        .HasColumnType("double precision");

                    b.Property<double?>("NetTxP95")
                        .HasColumnType("double precision");

                    b.Property<Guid>("NodeId")
                        .HasColumnType("uuid");

                    b.Property<float?>("PingLossAvg")
                        .HasColumnType("real");

                    b.Property<float?>("PingLossMax")
                        .HasColumnType("real");

                    b.Property<float?>("PingLossP95")
                        .HasColumnType("real");

                    b.Property<float?>("PingRttAvg")
                        .HasColumnType("real");

                    b.Property<float?>("PingRttMax")
                        .HasColumnType("real");

                    b.Property<float?>("PingRttP95")
                        .HasColumnType("real");

                    b.Property<float?>("RamAvg")
                        .HasColumnType("real");

                    b.Property<float?>("RamMax")
                        .HasColumnType("real");

                    b.Property<float?>("RamMin")
                        .HasColumnType("real");

                    b.Property<float?>("RamP95")
                        .HasColumnType("real");
                    ...
                    b.HasIndex("NodeId", "Granularity", "BucketStartUtc")
                        .IsUnique();
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.TelemetrySnapshot", b =>
                {
                    ...
                    b.Property<string>("ProcessTelemetryJson")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.User", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.UserDashboard", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.UserPermission", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.WidgetConfig", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("DashboardId", "DisplayOrder");
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.SystemUpdateHistory", b =>
                {
                    ...
                    b.HasOne("ManLab.Server.Data.Entities.Node", null)
                        .WithMany("SystemUpdateHistories")
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.SystemUpdateLog", b =>
                {
                    b.HasOne("ManLab.Server.Data.Entities.SystemUpdateHistory", "UpdateHistory")
                        .WithMany("Logs")
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.UserPermission", b =>
                {
                    b.HasOne("ManLab.Server.Data.Entities.User", "User")
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.WidgetConfig", b =>
                {
                    b.HasOne("ManLab.Server.Data.Entities.UserDashboard", "Dashboard")
                        .WithMany("Widgets")
            ...
            modelBuilder.Entity("ManLab.Server.Data.Entities.Node", b =>
                {
                    ...
                    b.Navigation("SystemUpdateHistories");
