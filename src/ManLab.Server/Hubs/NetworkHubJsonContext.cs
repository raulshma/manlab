...
[JsonSerializable(typeof(HostFoundBatchEvent))]
[JsonSerializable(typeof(SpeedTestStartedEvent))]
[JsonSerializable(typeof(SpeedTestProgressEvent))]
[JsonSerializable(typeof(SpeedTestCompletedEvent))]
[JsonSerializable(typeof(SpeedTestFailedEvent))]
[JsonSerializable(typeof(ScanCompletedEvent))]
[JsonSerializable(typeof(ScanFailedEvent))]
[JsonSerializable(typeof(WolSendResult))]
[JsonSerializable(typeof(MacVendorLookupResult))]
...
[JsonSerializable(typeof(SpeedTestProgressUpdate))]
[JsonSerializable(typeof(SpeedTestProgress))]
[JsonSerializable(typeof(SpeedTestMetadata))]
[JsonSerializable(typeof(List<DiscoveredHost>))]
[JsonSerializable(typeof(List<TracerouteHop>))]
[JsonSerializable(typeof(List<PacketCaptureRecord>))]
